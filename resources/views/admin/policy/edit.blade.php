                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Policy <small>Edit</small></h3>
                        </div>

                        {!! Form::model($policy, ['url' => url('admin/policy/' . $policy['PUNIQID']), 'method' => 'patch', 'files'=>true, 'class' => 'form-horizontal store-policy-info']) !!}
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button data-url="{{ url('admin/policy') }}" class="btn btn-info save-policy" type="button">Edit</button>
                                </div>
                            </div>
