                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">EDIT Franchisee</h3>
                        </div>

                        {!! Form::model($franchisee, ['url' => url('admin/franchisee-master/' . $franchisee['franchid']), 'method' => 'patch', 'files'=>true, 'class' => 'form-horizontal']) !!}
