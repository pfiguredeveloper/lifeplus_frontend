                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Multi-Plan Presentation <small>Add</small></h3>
                        </div>

                        {!! Form::open(['url' => url('admin/multi-policy'), 'files'=>true, 'method' => 'post', 'class' => 'form-horizontal store-policy-info']) !!}
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button data-url="{{ url('admin/multi-policy') }}" class="btn btn-info save-policy" type="button">Add</button>
                                </div>
                            </div>
