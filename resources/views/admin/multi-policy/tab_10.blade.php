            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-4">
                            <div class="col-sm-12">
                                <div class="form-group{{ $errors->has('QUOTNO') ? ' has-error' : '' }}">
                                    <label>Quot. No.</label>
                                    {!! Form::number('QUOTNO', null, ['class' => 'form-control','id'=>'QUOTNO','min'=>0]) !!}
                                    @if ($errors->has('QUOTNO'))
                                        <span class="help-block">
                                            <strong style="color: red;">{{ $errors->first('QUOTNO') }}</strong>
                                        </span>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="col-sm-12">
                                <div class="form-group{{ $errors->has('QUOTDT') ? ' has-error' : '' }}">
                                    <label>Quot. Dt.</label>
                                    {!! Form::text('QUOTDT', null, ['class' => 'form-control datepicker3', 'placeholder' => 'dd/mm/yyyy','id'=>'QUOTDT']) !!}
                                    @if ($errors->has('QUOTDT'))
                                        <span class="help-block">
                                            <strong style="color: red;">{{ $errors->first('QUOTDT') }}</strong>
                                        </span>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="col-sm-12">
                                <div class="form-group{{ $errors->has('QUOTREF') ? ' has-error' : '' }}">
                                    <label>Quot. Ref</label>
                                    {!! Form::text('QUOTREF', null, ['class' => 'form-control','id'=>'QUOTREF']) !!}
                                    @if ($errors->has('QUOTREF'))
                                        <span class="help-block">
                                            <strong style="color: red;">{{ $errors->first('QUOTREF') }}</strong>
                                        </span>
                                    @endif
                                </div>
                            </div>
