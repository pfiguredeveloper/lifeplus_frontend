...
<body>
    <header>
        ...
        <p style="margin-bottom: 0px;margin-top: 0px;text-align: center;"><b>Wedding Day List</b></p>
    ...
    <table class="table table-bordered" style="border-left: none;border-right: none;table-layout:fixed;font-size: 13px;">
        ...
        <tbody style="border-left: none;border-right: none;border-bottom: none;">
            ...
            <tr style="border-left: none;border-right: none;border-bottom: none;padding-top: 0px;padding-bottom: 0px;">
                ...
                <td style="border-left: none;border-right: none;border-bottom: none;width:25%;padding-top: 0px;padding-bottom: 0px;">{{ !empty($value['WDT']) ? \Carbon\Carbon::createFromFormat('Y-m-d', $value['WDT'])->format('d/m/Y') : ""}}</td>
