...
<title>Fully Paid Policy Report</title>
...
<body>
    <header>
        ...
        <p style="margin-bottom: 0px;margin-top: 0px;text-align: center;"><b>Fully Paid Policy Report ( Name Wise )</b></p>
            ...
            <thead>
                ...
                @foreach($dData as $key => $newArr)
                    @foreach($newArr as $value)
                        <?php 
                            $totalSA   += !empty($value['SA']) ? $value['SA'] : 0;
                            $totalPrem += !empty($value['PREM']) ? $value['PREM'] : 0;
                        ?>
                    @endforeach
                @endforeach
                <tr style="border-bottom: none;padding-top: 0px;padding-bottom: 0px;border: 1px solid black">
                    ...
                    <th style="border-bottom: none;width:20%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-left: none;border-right: none;">{{ number_format($totalSA)  }}</th>
                    ...
                    <th style="border-bottom: none;width:25%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-left: none;">{{ number_format($totalPrem) }}</th>
                </tr>
            </thead>
        </table>
    ...
    <table class="table table-bordered" style="border-left: none;border-right: none;table-layout:fixed;font-size: 12px;color: black;">
        <thead>
            <tr>
                ...
                <th style="width:15%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-left: none;border-right: none;border-bottom: none;text-align: right;">Basic SA</th>
                ...
                <th style="width:13%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-left: none;border-right: none;border-bottom: none;">Mode</th>
            ...
            <tr>
                ...
                <th style="width:15%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-left: none;border-right: none;border-top: none;text-align: right;">Mat.Date</th>
                ...
                <th style="width:13%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-left: none;border-right: none;border-top: none;">FUP</th>
            ...
            @foreach($dData as $key => $newArr)
                ...
                @foreach($newArr as $value)
                    ...
                    <tr>
                        ...
                        <td style="border:none;width:54%;padding-top: 0px;padding-bottom: 0px;">{{ (!empty($value['Party']) && !empty($value['Party']->NAME)) ? $value['Party']->NAME : '' }}</td>
                        <td style="border:none;width:15%;padding-top: 0px;padding-bottom: 0px;">{{ !empty($value['PONO']) ? $value['PONO'] : 0 }}</td>
                        <td style="border:none;width:13%;padding-top: 0px;padding-bottom: 0px;text-align: right;">{{ !empty($value['SA']) ? $value['SA']+0 : 0 }}</td>
                        ...
                        <td style="border:none;width:10%;padding-top: 0px;padding-bottom: 0px;">{{ $mode }}</td>
                    ...
                    <tr>
                        ...
                        <td style="border-left: none;border-right: none;border-top: none;width:54%;padding-top: 0px;padding-bottom: 0px;border-bottom: 1px solid black;">
                        ...
                        <td style="border-left: none;border-right: none;border-top: none;width:13%;padding-top: 0px;padding-bottom: 0px;border-bottom: 1px solid black;text-align: right;">{{ !empty($value['MATDATE']) ? \Carbon\Carbon::createFromFormat('Y-m-d', $value['MATDATE'])->format('d/m/Y') : '' }}</td>
                        ...
                        <td style="border-left: none;border-right: none;border-top: none;width:10%;padding-top: 0px;padding-bottom: 0px;border-bottom: 1px solid black;">{{ !empty($value['FUPDATE']) ? \Carbon\Carbon::createFromFormat('Y-m-d', $value['FUPDATE'])->format('d/m/Y') : '' }}</td>
