...
<style type="text/css">
    ...
    body {margin-top: 285px;margin-bottom: 20px;}
    ...
    <header>
        ...
        <div class="table-hd">
            <div class="tr-hd">
                ...
                <div class="d2-hd">Cash Flow Statement</div>
    ...
    <table class="table table-bordered" style="border-left: none;border-right: none;table-layout:fixed;font-size: 13px;">
        <thead style="background-color: #d40a55;color: white;font-weight: bold;">
            <tr>
                ...
                <td style="width:24%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-right: none;border-left: none;border-bottom: none;">Name</td>
                <td style="width:10%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-right: none;border-left: none;border-bottom: none;">Due Dt.</td>
                <td style="width:5%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-right: none;border-left: none;border-bottom: none;">Age</td>
                <td style="width:10%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-right: none;border-left: none;border-bottom: none;">Pol No.</td>
                <td style="width:10%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-right: none;border-left: none;border-bottom: none;">Amount</td>
                <td style="width:10%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-right: none;border-left: none;border-bottom: none;">Bonus</td>
                <td style="width:10%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-right: none;border-left: none;border-bottom: none;">Total</td>
                <td style="width:10%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-right: none;border-left: none;border-bottom: none;">Yly Tot.</td>
                <td style="width:6%;padding-top: 0px;padding-bottom: 0px;border: 1px solid black;border-left: none;border-bottom: none;">Type</td>
            </tr>
        </thead>
        <tbody style="color: #080888;">
            @for($i=1;$i<25;$i++)
            <tr>
                <td style="border-left: none;border-right: none;width:5%;padding-top: 0px;padding-bottom: 0px;">{{$i}}</td>
                <td style="border-left: none;border-right: none;width:24%;padding-top: 0px;padding-bottom: 0px;">Baxo keyurbhai jitubhai</td>
                <td style="border-left: none;border-right: none;width:10%;padding-top: 0px;padding-bottom: 0px;">28/07/2008</td>
                <td style="border-left: none;border-right: none;width:5%;padding-top: 0px;padding-bottom: 0px;">44</td>
                <td style="border-left: none;border-right: none;width:10%;padding-top: 0px;padding-bottom: 0px;">813254049</td>
                <td style="border-left: none;border-right: none;width:10%;padding-top: 0px;padding-bottom: 0px;">40000</td>
                <td style="border-left: none;border-right: none;width:10%;padding-top: 0px;padding-bottom: 0px;">17000</td>
                <td style="border-left: none;border-right: none;width:10%;padding-top: 0px;padding-bottom: 0px;">40000</td>
                <td style="border-left: none;border-right: none;width:10%;padding-top: 0px;padding-bottom: 0px;">40000</td>
                <td style="border-left: none;border-right: none;width:6%;padding-top: 0px;padding-bottom: 0px;">Mat.</td>
            </tr>
        @endfor
        </tbody>
    </table>
