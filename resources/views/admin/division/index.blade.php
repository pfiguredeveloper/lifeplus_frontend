...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('admin/division-master')}}"><i class="fa fa-dashboard"></i> {{ $menu }}</a></li>
            </ol>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-header">
                            <h3 class="box-title"><a href="{{ url('admin/division-master/create/') }}" ><button class="btn bg-orange margin" type="button">Add Division</button></a></h3>
                        </div>
                        @endcan
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group-horizontal">
                                                    @can('division_edit')
                                                    {{ Form::open(array('url' => 'admin/division-master/'.$list['id'].'/edit', 'method' => 'get','style'=>'display:inline')) }}
        ...
        <div id="myModal_DELETE" class="fade modal modal-danger" role="dialog" >
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{route('division-master.destroy','test')}}" method="post">
                        {{method_field('delete')}}
                        {{csrf_field()}}
